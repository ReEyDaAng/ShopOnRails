...
ActiveRecord::Schema[7.1].define(version: 2026_01_12_140000) do
  create_schema "auth"
  ...
  create_table "orders_descriptions", force: :cascade do |t|
    ...
    t.index ["order_id", "item_id"], name: "index_orders_descriptions_on_order_id_and_item_id", unique: true
